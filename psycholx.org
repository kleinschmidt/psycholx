...
Phenomena/concepts: Common ground, perspective taking, and scalar implicature

Tasks/evidence - "referrential communication task", privileged/common ground
manipulated in various ways (e.g. cubby hole task).  Analyze *forms produced*
and *real-time interpretation* (what would egocentric predict?)
